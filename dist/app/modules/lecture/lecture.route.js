...
const lectureUpload_middleware_1 = require("../../middlewares/lectureUpload.middleware");
...
router.post('/', lectureUpload_middleware_1.lectureUploadMiddleware, lectureUpload_middleware_1.processLectureFiles, (0, validateRequest_1.default)(lecture_validation_1.lectureValidation.createLecture), (0, auth_1.default)(['admin']), lecture_controller_1.LectureControllers.createLecture);
router.put('/:id', lectureUpload_middleware_1.lectureUploadMiddleware, lectureUpload_middleware_1.processLectureFiles, (0, validateRequest_1.default)(lecture_validation_1.lectureValidation.updateLecture), (0, auth_1.default)(['admin']), lecture_controller_1.LectureControllers.updateLecture);
